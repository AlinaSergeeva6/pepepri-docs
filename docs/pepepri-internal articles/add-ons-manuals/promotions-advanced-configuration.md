...
-   **Steps:**
    1.  Go to **Views and Forms → Order Center → Cart Line Menu Configuration**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-693.png)
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-694.png)
...
-   **Steps:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-695.png)
...
-   **Steps:**
    ...
    3.  **Update Workflow:**
        ...
        -   Edit the In Creation transition in both branches.
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-696.png)

        -   Add the fields to the **Merge Transaction Lines** action (e.g., map TSAmyPrice to TSAmyPrice).

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-697.png)

#### 4. Pass Promotion Code to Line Items in Original Transaction

![](https://alinasergeeva6.github.io/pepepri-docs/static/image-698.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-699.png)
...
-   **Steps:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-700.png)
...
-   **Steps:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-701.png)
...
-   **Steps:**
    1.  **Add Package Transaction Type:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-702.png)
    ...
    2.  **Configure Transaction Type:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-703.png)

    3.  **Create Custom Quantity Field:**
        -   Add a custom line-item field (e.g., MyUnitsQuantity, type: Number) to return UnitsQuantity.

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-704.png)

    4.  **Update Order Center Views:**
        -   Replace UnitsQuantity with MyUnitsQuantity in views (e.g., Medium or Grid Line).
        -   Set as read-only.

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-705.png)

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-706.png)

    5.  **Result:** Users can select the new transaction type in the Package Editor for kits.

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-707.png)
...
-   **Steps:**
    1.  Go to **Settings → Sales Activities → Transaction Types → \[PPI\_PackagePromotion or PPI\_PackagePromotionAdditionalItems\] → Settings**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-708.png)
...
-   **Steps:**
    ...
    2.  **Update Pricing Logic:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-709.png)
...
-   **Steps:**
    ...
    2.  Enter the List IDs:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-710.png)
    ...
    3.  **Find List IDs:**
        -   **Account List (Old Format):**
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-711.png)
        ...
        -   **Item List or Account List (New Format):**
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-712.png)
...
-   **Steps:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-713.png)
