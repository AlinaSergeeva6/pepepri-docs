---
title: "Order Trade Promotions Installation Guide"
order: 79
---
...
3.  **Install the Add-On:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-633.png)
...
1.  **Run Installation per Transaction Type:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-634.png)
    ...
    -   **Outcome:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-635.png)

        -   Creates custom Transaction fields (prefix PPI\_OrderPromotion).

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-636.png)
...
1.  **Define Promotion Types in the Types Editor:**
    ...
    -   **Fields:**
        ...
        -   **Promotion Properties:**
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-637.png)
    ...
    -   Edit the workflow for each Transaction Type with Order Trade Promotions:
        ...
        -   Add the following actions in the transition to the final status (e.g., In Creation → Submit):
            -   **Calculate Formula Action:** Use the PPI\_OrderPromotion\_Trigger field.
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-638.png)
            ...
            -   **Branch Action:** Use the PPI\_OrderPromotion\_AdditionalPhaseShouldStart field (failure workflow continues to the same status).
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-639.png)

            -   **Open Campaign Action:** Use the PPI\_OrderPromotion\_AdditionalPhaseItemExternalID field after the Branch action.

                ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-640.png)
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-641.png)
...
4.  **Advanced Configuration for Additional Phase:**
    -   If the promotion includes an additional phase (e.g., selecting free/discounted items):
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-643.png)
...
5.  **Create Item Lists:**
    ...
    -   Define a default list (if preferred):
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-644.png)
