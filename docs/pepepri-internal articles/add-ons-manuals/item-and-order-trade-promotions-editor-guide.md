...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-651.png)
...
-   **Steps:**
    1.  **Open Editor:** Click **Add** in the Item Promotions Editor.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-652.png)
    ...
    2.  **Fill Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-653.png)

    3.  **Save and Set Values:**
        -   Click **Save**, then **Values**.

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-654.png)

        -   Select: Account Size = "Medium", Main Category = "Nail Polish".

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-655.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-656.png)

![](https://alinasergeeva6.github.io/pepepri-docs/static/image-657.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-658.png)

    -   **Save and Set Items:**
        -   Click **Items**, select by Item ID, choose 3 face creams (e.g., A, B, C).
        -   Select Transaction Type: "B2B eCommerce Order".

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-659.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-660.png)

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-661.png)

    -   **Save and Set Items:**
        -   Click **Items**, select by Item ID, choose 2 items (e.g., SE50, SE140).

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-662.png)

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-663.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-664.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-665.png)

    -   **Save and Set Values:** Select Transaction Type = "B2B eCommerce Order".

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-666.png)

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-667.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-668.png)

    -   **Set Values:** Select Account Default Payment = "Credit", Payment Method Selected = "Cash".

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-669.png)

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-670.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-671.png)

    -   **Configure Additional Items:**

        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-672.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-673.png)
