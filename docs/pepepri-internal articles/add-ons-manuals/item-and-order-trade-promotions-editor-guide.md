...
![](/static/image-656.png)

![](/static/image-657.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](/static/image-660.png)

        ![](/static/image-661.png)

    -   **Save and Set Items:**
        -   Click **Items**, select by Item ID, choose 2 items (e.g., SE50, SE140).

        ![](/static/image-662.png)

        ![](/static/image-663.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](/static/image-671.png)

    -   **Configure Additional Items:**

        ![](/static/image-672.png)
