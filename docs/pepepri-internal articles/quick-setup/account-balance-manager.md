...
1.  **Create a New Activity:**
    ...
    -   Click **Add New Activity** and create a new activity named "Ledger".
        ...
        ![](/static/Screenshot-2024-12-12-at-16.36.50.png)
...
2.  **Add a Custom Form to the Activity:**
    ...
    ![](/static/Screenshot-2024-12-12-at-16.40.17.png)

3.  -   **Update the Config ID:**
        -   Inside the Custom Form code, locate the page\_url parameter.

    ![](/static/Screenshot-2024-12-12-at-17.25.38.png)
...
![](/static/Screenshot-2024-12-12-at-17.29.20.png)
...
![](/static/Screenshot-2024-12-12-at-17.34.15.png)
