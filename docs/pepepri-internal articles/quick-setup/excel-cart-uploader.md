...
-   Navigate to **Settings -> iPaaS -> Quick Setup -> Excel Cart Uploader**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-945.png)
...
-   Add a new configuration or copy an existing one and modify it as needed.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-946.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-947.png)
...
-   **Select Transaction:** Choose the Transaction Type (e.g., Sales Order, B2B Order) that will be updated with the uploaded Excel data.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-948.png)

**Excel Fields Mappings Tab**

![](https://alinasergeeva6.github.io/pepepri-docs/static/image-949.png)
...
-   **Add Field:** Click **Add** to include a new field in the uploader configuration.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-950.png)

-   **Edit Field:** Click **Edit** to update the Column Name or Source Field as needed.

    ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-951.png)

**Advanced Tab**

![](https://alinasergeeva6.github.io/pepepri-docs/static/image-952.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/image-953.png)
...
1.  **Create Custom Form with UI Task:**
    ...
    -   Click the icon to copy the UI task code.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-954.png)
...
2.  **Add Program to Transaction Type:**
    ...
    -   Add a new **Custom Form Action** and paste the copied UI task code.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/static/image-955.png)
