...
-   **Select Transaction:** Choose the Transaction Type (e.g., Sales Order, B2B Order) that will be updated with the uploaded Excel data.
    ...
    ![](/static/image-948.png)

**Excel Fields Mappings Tab**

![](/static/image-949.png)
