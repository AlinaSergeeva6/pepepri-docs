...
![](https://alinasergeeva6.github.io/pepepri-docs/static/98Capture.PNG)

**IMPORTANT** column is ID (ExternalID)

![](https://alinasergeeva6.github.io/pepepri-docs/static/C567apture.PNG)

2\. Сreate a dataflow task, which will take a table with data and do loop\_over\_table of the first dataflow task

![](https://alinasergeeva6.github.io/pepepri-docs/static/78.PNG)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/67Capture.PNG)

![](https://alinasergeeva6.github.io/pepepri-docs/static/kkkk.PNG)
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/56.PNG)
