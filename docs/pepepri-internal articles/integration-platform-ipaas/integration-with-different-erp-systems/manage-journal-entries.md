...
In order to start working with SAP ByDesign and manage journal entries, read General overview on SAP ByDesign [here](/integration-platform-ipaas/integration-with-different-erp-systems/sap-bydesign.md) and get familiar with this documentation:
