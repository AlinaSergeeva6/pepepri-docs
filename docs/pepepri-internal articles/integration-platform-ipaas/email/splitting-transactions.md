...
![](/static/image-284.png)

2\. HTTP task to get the Transaction Lines - and perform Join with Task 1

![](/static/image-285.png)

![](/static/image-286.png)
