...
![](https://alinasergeeva6.github.io/pepepri-docs/static/1-21.jpg)

3) When you input correct data you will get data navigation through file manager section

![](https://alinasergeeva6.github.io/pepepri-docs/static/2-16.jpg)

4) After that go to the integration platform and create dataflow task with this settings:

![](https://alinasergeeva6.github.io/pepepri-docs/static/3-11.jpg)

5) Configuration of settings in dataflow task.

![](https://alinasergeeva6.github.io/pepepri-docs/static/4-7.jpg)
