---
title: "Create and Navigate to Transaction or Item Details"
description: "This page describes how to set up flow 'Create and navigate to transaction or item details'"
order: 273
---
# Create and Navigate to Transaction or Item Details

*This page describes how to set up flow 'Create and navigate to transaction or item details'*
...
2.  Add new script:
    ...
    2.  **Parameters**:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-221.png)
...
4.  Go to **Parameters tab** and add the following variables:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-222.png)

5.  In **Steps tab** add user script block with the following values:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-223.png)
...
5.  Find **Click Event** in Settings: Usually situated in Block Settings (i.e. Gallery, Banner or Slideshow Settings) -> Content -> Expand element -> **Click Event** Settings
...
7.  **Required** parameters:
    ...
    2.  **catalog\_name** \- catalogs, i.e Default Catalog, Default Catalogue, Pre Order Christmas
        ...
        !!!danger
        The **catalog\_name** must exist on the transaction specified in **atd\_name**.
        !!!

8.  **Optional** paramaters:
    1.  **account\_uuid** It is required for Multi-Account buyer, must be **dynamic** with **AccountUUID** value selected. See how to set up Multi-Account buyer flow in [Get Accounts for Filter](/pepperi/custom-homepages/get-accounts-for-filter.md). If there are absent Multi-Account buyers on the environment, it should be left **empty**.
    ...
    3.  **filter** If you navigate to any order you will see the following:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-224.png)
    ...
    4.  **smart\_filter** Similarly to the filter, smart filter can also be viewed in opened transaction - expand one of the sections below the filter, choose value and click **apply**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-225.png)
    ...
    5.  **view\_type** Open transaction and select any view from the dropdown:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-226.png)
