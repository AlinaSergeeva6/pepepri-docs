...
2.  Add new script:
    ...
    2.  **Parameters**:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-227.png)
...
2.  Add new onLoad flow: Name: **Homepage On Load - Multi Account** Parameters:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-228.png)

    Steps: As Transaction type add the **transaction name** from the environment, i.e. Sales Order, B2B Sales Order, Buyer Order, etc.

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-229.png)
...
4.  Add new flow for opening transaction:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-230.png)

    Steps:

    1.  **User Script** block:

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-231.png)

    2.  After that, add **Navigate To** Logic Block:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-232.png)
...
3.  In page settings add onLoad flow:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-233.png)

4.  Also add the page onChange flow:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-234.png)
...
7.  **Dynamic** parameters: Parameters accountUUID, transactionUUID, catalogExId, atdName should be dynamic:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-235.png)
