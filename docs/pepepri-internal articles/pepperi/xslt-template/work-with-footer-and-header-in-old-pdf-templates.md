---
title: "Work with Footer and Header in Old PDF templates"
order: 296
---
...
*"Error message on PDF2\_NoPrice "This page contains the following errors: error on line X at column Y: Opening and ending tag mismatch: div line 0 and footer Below is a rendering of the page up to the first error. This document was created as the result of an XSL transformation. The line and column numbers given are from the tranformed result."*
