...
description: "to examine the information in greater detail, please, check https://developers.google.com/analytics"
order: 263
---
# Google Analytics

*to examine the information in greater detail, please, check https://developers.google.com/analytics*

**REMARKS** **Google Analytics** is a web analytics service offered by Google that is used to track website activity such as session duration, pages per session, bounce rate etc. of individuals using the site, along with the information on the source of the traffic.
...
![](https://alinasergeeva6.github.io/pepepri-docs/static/Screenshot-2021-09-17-at-12.31.31.png)

![](https://alinasergeeva6.github.io/pepepri-docs/static/Screenshot-2021-09-17-at-12.32.18.png)
...
**REMARKS** **Metrics** are what produce the numbers you’ll find in the platform. Anything that can be measured with a number is a metric. Think of the number of users, number of purchases, value of conversions, average time on site, etc.
...
### #1 Step: The Google Analytics tag
