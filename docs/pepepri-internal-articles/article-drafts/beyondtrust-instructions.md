---
title: "BeyondTrust instructions"
order: 11
---
...
1.  **Check for the BeyondTrust tile in Okta.**
    -   If you **don’t** see a BeyondTrust tile, submit an **IT case** *(servicedesk@advantive.com)* requesting to be added to **“BeyondTrust PRA Okta Group.”**
...
3.  **Request business unit access for customer endpoints.**
    -   Create a **Client Operations** *(clientoperations@advantive.com)* case asking to be added to the **BeyondTrust PRA group for** ***\[your Business Unit\].*** *(Pepepri)*
...
![Cover](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/1583973260045.jpeg)
...
![Cover](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/images.png)
...
![Cover](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/Pepperi__1_.webp)

Pepperi

[https://advantive.beyondtrustcloud.com/download\_client\_connector?fn=sra-pin-win\_x64-j130ey76jj7wg6edjzi1xejzji7zi675whw1cry0hf7c90.msi&jc=8d5b005f4b890a17e80a015a1b5cf3f7&p=winNT-64-msi&ss=c49dc2711d7732d1ebf92ba663f7ee5b29d0b098](https://advantive.beyondtrustcloud.com/download_client_connector?fn=sra-pin-win_x64-j130ey76jj7wg6edjzi1xejzji7zi675whw1cry0hf7c90.msi&jc=8d5b005f4b890a17e80a015a1b5cf3f7&p=winNT-64-msi&ss=c49dc2711d7732d1ebf92ba663f7ee5b29d0b098)
...
1.  **Open the BeyondTrust PRA Access Console.** Log into customer sites from the Access Console.
    ...
    3.  *Option 3: Jump Box* *(we don't have this option for now)*
        1.  *If your business unit has a jumpbox, you can access the jumpbox first.*
        2.  *Next, use option 2, above, to log into the Access Console on the jumpbox.*

2.  **Find the endpoint:**
    -   Search for the customer **Account Name** under your **Business Unit’s Endpoints**. ***Can’t Find the Customer’s Endpoint?*** *Refer to the Can’t Find the Customer’s Endpoint? in the* ***💡Tips*** *section at the bottom of this article*

3.  **Connect to the server:**
    -   Double-click the account name **or** right-click → **Jump**.

4.  *Log in using the Vault (preferred)* *(we don't have this option for now)**:*
    -   *Click the Key icon to view Vault accounts.*
    -   *Select the account → Inject to log in with Windows credentials.*
    -   *If the account isn’t in Vault, get credentials from the relevant Environment object in Salesforce*.

5.  **Perform your remote support.**
6.  **When finished:**
    -   **Log the user off** on the customer machine.
    -   **End** your session in BeyondTrust (red **X** → **End Session**).
    -   If you’re on a jumpbox, ensure the session has fully ended before leaving the jumpbox.
...
-   Email the **PEC log file** (and any relevant logs) to *erika.youmans@advantive.com.*
...
*Insert BeyondTrust Jump Client Link*
...
[Windows BLOG (Standard) (3).zip](https://3916435711-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LfO_rsQzfnV957oTV_f%2Fuploads%2FSrrSG0pDCOI2smZ52bMT%2FWindows%20BLOG%20(Standard)%20(3).zip?alt=media&token=c85c7edc-4c24-4be1-8b10-c9a67075a37b)

archive

[Open](https://3916435711-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LfO_rsQzfnV957oTV_f%2Fuploads%2FSrrSG0pDCOI2smZ52bMT%2FWindows%20BLOG%20(Standard)%20(3).zip?alt=media&token=c85c7edc-4c24-4be1-8b10-c9a67075a37b)
