...
-   **Tasks Overview:**
    -   **Dataflows:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-990.png)
...
1.  **Parse Webhook Logs - Get All Failed Transactions By Date Range**
    ...
    -   **Parameters (Client-Specific):**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-991.png)
...
4.  **Parse Webhook Logs - Generate Final Report**
    ...
    -   **Customization:** Open the JS Script tab, locate the regexList variable, and update the array with desired patterns to parse log data
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-992.png)

    -   **Example:**
        -   When a webhook fails, we receive this log
        -   That contains this data

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-993.png)
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-994.png)
