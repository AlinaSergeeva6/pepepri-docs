---
title: "Working with xlsx files using JavaScript"
description: "This example you can find in 'Integration Examples' (6685) ,UI Task name: Upload Any Data via xlsx"
order: 294
---
# Working with xlsx files using JavaScript

*This example you can find in 'Integration Examples' (6685) ,UI Task name: Upload Any Data via xlsx*
