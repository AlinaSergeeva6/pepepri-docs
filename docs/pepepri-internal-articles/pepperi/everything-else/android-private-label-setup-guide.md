...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-256.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-257.png)

Pic2

1.  It downloads a file, find it:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-258.png)

Pic3

1.  Back to Play Console. Go to Internal Testing:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-259.png)

Pic4

1.  Create New Release:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-260.png)

Pic5

1.  Click Choose Signing Key – Use Google Generated Key:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-261.png)

Pic6

1.  Upload the First APK Bundle that you downloaded:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-262.png)

Pic7

Uploaded:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-263.png)
...
1.  RELEASE (fully) to INTERNAL TESTING the release with the First APK bundle. Otherwise API from Pepperi won’t pick up the Build # to increment for version #2 on final release! **Note:** It’s not necessary to actually do any “internal testing”. The app is what it is. Save time and continue to the next steps towards Prod release.
    1.  **Create Service Account Key:** a. Go to console.cloud.google.com/apis/dashboard and Create a Project, and select it from the dropdown at the top.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-264.png)
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-265.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-266.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-267.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-268.png)

Pic13

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-269.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-270.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-271.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-272.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-273.png)

Pic18

1.  Fix all errors (mostly just answering questions, answer them all with a “minimalist” assumption.):

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-274.png)

Pic19

1.  Set the production release for review after correcting all errors:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-275.png)
