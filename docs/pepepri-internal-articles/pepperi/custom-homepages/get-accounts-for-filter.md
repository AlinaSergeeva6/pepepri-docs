...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-216.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-217.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-218.png)

1.  Click on **Choose Flow** and select **Get Accounts for Filter** option

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-219.png)
...
3.  Go to **Preview** to see the Account dropdown. You can also **publish** the homepage, in order to view the changes on the **live page**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-220.png)
