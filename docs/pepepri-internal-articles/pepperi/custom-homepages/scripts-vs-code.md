...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-168.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-169.png)

2) Wait till the installation is completed:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-170.png)

3) When ready, you will see the following new folders and files:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-171.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-172.png)

2) Paste the idp\_token to the **jwt** file:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-173.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-174.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-175.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-176.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-177.png)

To remove red underline:

1) Go to **tsconfig.json**

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-178.png)

2) Add **"strictNullChecks": false** to *compilerOptions*:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-179.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-180.png)

-   VS Code will suggest the parameter you need to add:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-181.png)

-   Once you've added the suggested parameter and everything is correct, the error indication will disappear:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-182.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-183.png)

2) This will redirect you to the function in the declaration file '**create-globals.d.ts**':

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-184.png)

3) Use **Ctrl + LMB** (for macOS: **Cmd + LMB**) on Params (the exact name could differ: UDTGetList**Params**, Get**Params**, Search**Params**, etc.):

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-185.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-186.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-187.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-188.png)

3) You will be redirected to '**index.d.ts**' and see the function output structure:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-189.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-190.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-191.png)

4) Click on the "Start Debugging" green arrow:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-192.png)

5) Go to "Debug Console". Here you will see all the application logs:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-193.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-194.png)

Errors will be highlighted in red:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-195.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-196.png)

3) Enter parameters manually:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-197.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-198.png)
!!!
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-199.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-200.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-201.png)

-   If the value is an object it could be displayed as "Proxy":

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-202.png)

In Debug Console write JSON.stringify(your\_object):

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-203.png)

### Possible errors

#### Fetch error while running npx debug-script &lt;script.key> command

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-204.png)

#### How to fix

-   make sure the app and VS Code are in one window:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-205.png)
