...
2.  Add new script:
    ...
    2.  **Parameters**:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-221.png)
...
4.  Go to **Parameters tab** and add the following variables:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-222.png)

5.  In **Steps tab** add user script block with the following values:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-223.png)
...
8.  **Optional** paramaters:
    ...
    3.  **filter** If you navigate to any order you will see the following:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-224.png)
    ...
    4.  **smart\_filter** Similarly to the filter, smart filter can also be viewed in opened transaction - expand one of the sections below the filter, choose value and click **apply**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-225.png)
    ...
    5.  **view\_type** Open transaction and select any view from the dropdown:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-226.png)
