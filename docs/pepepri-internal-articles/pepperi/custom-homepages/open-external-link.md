...
2.  Add new script:
    ...
    2.  Parameters:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-240.png)
...
4.  Go to **Parameters tab** and add the following variable:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-241.png)

5.  In **Steps tab** add user script block with the following values:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-242.png)
...
4.  Add the following flow with the Link to navigate the user by:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-243.png)
