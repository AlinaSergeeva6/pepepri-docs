...
2.  Add new script:
    ...
    2.  **Parameters**:
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-236.png)
...
4.  Go to **Parameters tab** and add the following variables:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-237.png)

5.  In **Steps tab** add user script block with the following values:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-238.png)
...
5.  **url\_param**: used to open pepperi link, for instance **/list/all\_activities** (must have leading '/' to work in mobile)
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-239.png)
