...
-   Go to IPaaS → Tools → Desktop Application
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-324.png)

    -   On server you should see archive and SDK install file

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-325.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-326.png)

-   Run as admin OnlineListener.exe (this located in the same folder). If all ok you should see following:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-327.png)
...
-   Open your QuickBooks Intuit as Administrator. Login to your Company File and be sure that you in Single-Mode (thats need for integrate listener with current Company File).
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-328.png)
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-329.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-330.png)

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-331.png)

-   Run the Dataflow and check the server. You should receive a new window from QuickBooks Intuit requesting permission.
    -   Window with access

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-332.png)
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-333.png)

    -   If everything is set up correctly, you should receive data from the created dataflow

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-334.png)
...
>
> ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-335.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-336.png)
