...
-   Add the following settings:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-438.png)
...
-   Add the following settings:
    ...
    -   **is\_sql\_source:** Set to true
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-439.png)

-   Navigate to the **SQL** tab and write the desired SQL query (e.g., SELECT \* FROM Customers).

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-440.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-441.png)
