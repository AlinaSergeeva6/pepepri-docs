---
title: "QuickBooks Online API Integration"
description: "This guide provides step-by-step instructions for integrating QuickBooks Online with Pepperi using OAuth 2.0, focusing on HTTP request configuration in dataflow tasks."
order: 112
---
# QuickBooks Online API Integration

*This guide provides step-by-step instructions for integrating QuickBooks Online with Pepperi using OAuth 2.0, focusing on HTTP request configuration in dataflow tasks.*
...
-   **HTTP Request Configuration:**
    -   **companyID:** Each QuickBooks Online instance has a unique companyID, required in the HTTP request.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-553.png)
    ...
    -   **Query Example:** query=select \* from item STARTPOSITION {#page\_num#} retrieves all columns of items, with pagination support via STARTPOSITION.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-554.png)
...
-   **To Know More About QuickBooks Online API:** [https://developer.intuit.com/app/developer/qbo/docs/api/accounting/most-commonly-used/account](https://developer.intuit.com/app/developer/qbo/docs/api/accounting/most-commonly-used/account)
