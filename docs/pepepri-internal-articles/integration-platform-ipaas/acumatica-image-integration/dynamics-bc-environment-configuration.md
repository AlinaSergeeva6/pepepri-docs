...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-522.png)

b) In new BC versions - **Microsoft Entra** **Applications**:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-523.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-524.png)

Configure the app with your existing **Client ID** from Azure - Application (client) ID. Then add a **Description** (name):

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-525.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-526.png)

For basic configuration specify the following permissions:

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal%20articles/static/image-527.png)
