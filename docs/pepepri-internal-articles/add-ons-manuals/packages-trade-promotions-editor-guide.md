...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-674.png)

---

### Package Setup Overview

![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-675.png)
...
-   **Available Items:** Defines items available for selection in the package (Phase 1). For two-phase promotions, configure "Additional Selected Items" separately.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-676.png)

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-677.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-678.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-679.png)
...
-   **Steps:**
    1.  **Fill Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-680.png)
        ...
        -   **Message:** A pop-up message explaining the promotion (e.g., what quantities to select). Also displayed at the top of the selection screen.
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-681.png)
        ...
        -   **Tiers:** Define the promotion rules:
            ...
            -   **Limitations:** Add conditions (e.g., items from specific categories). Click **Edit Limitations** to set (e.g., 5 items from 2 different categories).
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-682.png)
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-683.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-684.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-685.png)
...
-   **Steps:**
    ...
    -   **Configure Additional Items:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-686.png)
        ...
        -   Title: "Select Free Items"
            -   Message: "Select {0} free items" (e.g., "Select 6 free items" for 15 items).
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-687.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-688.png)
        ...
        -   Get: Additional Items → Use Cheapest Item, Quantity: 1, Discount: 100%
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-689.png)
...
-   **Steps:**
    -   **Promotion Details:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-690.png)
    ...
    -   **Configure Additional Items:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-691.png)
...
-   **Steps:**
    ...
    -   **Set Available Items:**
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-692.png)
