...
3.  **Install the Add-On:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-625.png)
...
1.  **Run Installation per Transaction Type:**
    -   Navigate to **Settings → Promotion Setup → Item TP Setup**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-626.png)
...
-   **Outcome:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-627.png)

    -   Creates custom Transaction Line-Item fields (prefix PPI\_ItemPromotion).

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-628.png)
...
1.  **Define Promotion Types in the Types Editor:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-629.png)
    ...
    -   **Fields:**
        ...
        -   **Promotion Properties:**
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-630.png)
...
3.  **Create Item Lists:**
    ...
    -   Define a default list (if preferred):
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-631.png)
...
-   **Add Display Fields:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-632.png)
