...
1.  Navigate to **Settings -> Insights -> Data Queries**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-746.png)
...
1.  **Enter Details:**
    ...
    -   Select a **Resource**:
        ...
        -   A UDC defined in the **Targets Manager**: Use imported target data (see Target Resources for Insights Dashboards for details).
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-747.png)

2.  **Add a Series:**
    -   Define how data is aggregated:

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-748.png)
        ...
        -   **Aggregator:**
            ...
            -   Script: Write a custom calculation using aggregators and fields.
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-749.png)
...
3.  **Add Categories (Group By):**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-750.png)
    ...
    -   **Format:** Choose Year, YearMonth, Month, MonthDay, YearMonthDay, Week, WeekYear, Quarter, or QuarterYear.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-751.png)
...
4.  **Add Dynamic Series (Break By):**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-752.png)

    -   **Limit Results:** Specify the number of values to display.
    -   **Order:** Choose Ascending or Descending.

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-753.png)
...
5.  **Add Filters:**
    ...
    -   **Additional Filters:**
        ...
        -   Filter by Status Name (e.g., "submitted" transactions).
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-754.png)
...
2.  Add a variable:
    ...
    -   **Preview Value:** Value for query preview (e.g., a specific brand).
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-755.png)
...
4.  **Conditional Filtering (Optional):**
    -   Use the **Conditional Filter** section to apply filters only if a condition is met (e.g., filter by MainCategory only if not "All").
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-756.png)

5.  Verify in Preview:
    -   Adjust the **Preview Value** to see filtered data (e.g., change to a different brand).

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-757.png)
...
2.  **Manage Parameters:**
    ...
    -   **Default Value:** Set a default (e.g., "All" for no filter).
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-758.png)
...
4.  **Map Variables:**
    ...
    -   Select **Variable** and choose the page parameter.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-759.png)
...
3.  **Add a Section:** Click **Add Section**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-760.png)

4.  **Add a Block:** Drag and drop a block (e.g., Chart, Benchmark Chart, Scorecard, Table).

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-761.png)
...
5.  **Configure Content:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-762.png)
