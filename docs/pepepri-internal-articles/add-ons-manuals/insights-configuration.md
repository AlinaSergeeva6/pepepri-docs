...
2.  **Install Insights Add-on:**
    ...
    -   Wait for the installation to complete (this may take several minutes). Once done, a new **Insights** section will appear under **Settings**.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-716.png)
...
-   Use the **Configuration Assistant** to set up initial dashboards and data queries for Reps and Managers:
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-717.png)

    -   Configure the following:
        -   **Fields to Accumulate:** Select fields for data aggregation (only fields indexed in the Data Index will be available).

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-718.png)

        -   **Queries Filter:** Filter by Transaction Type or Status (e.g., select "submitted" for orders).

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-719.png)

        -   **Slugs & Pages to Create:** Default slugs are /insights and /account\_insights (customizable if needed).

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-720.png)

    -   Click **Run** to create three unpublished pages. A notification will confirm completion.

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-721.png)
...
1.  Navigate to **Settings -> Insights -> Data Index**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-722.png)
...
2.  **Activities & Transactions Tab:**
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-723.png)
...
3.  **Transaction Lines Tab:**
    ...
    -   Include any custom TSA fields relevant to your reporting needs.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-724.png)
...
![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-725.png)
...
1.  Go to **Settings -> Pages -> Page Builder**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-726.png)

2.  Locate the three new pages created by the Configuration Assistant.

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-727.png)
...
4.  Save and click **Publish** to make pages available.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-728.png)

#### Step 5: Assign User Profile Permissions

1.  Navigate to **Settings -> Pages -> Slugs -> Mapping**.

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-729.png)
...
2.  Add or edit user profiles:
    ...
    -   Select the corresponding page for each slug.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-730.png)
...
1.  Go to **Settings -> Company Profiles -> App Home Screen**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-731.png)
...
-   If you used the Insights Configuration Assistant, two default target UDCs are created:
    ...
    -   **UserTarget:** For user-level targets.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-732.png)
...
3.  Define the UDC:
    ...
    -   **Inherit Field From:** Select either user\_target or account\_target to inherit base fields (Date, User/Account, Target) and make the UDC available in the Targets Manager.
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-733.png)

4.  Ensure the **Scheme Only** checkbox is unchecked, then click **Create**.
5.  After creation, the UDC editor opens:

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-734.png)
    ...
    -   Add fields (e.g., Brand):
        ...
        -   **Optional Values:** List options (e.g., brand1, brand2, brand3a).
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-735.png)
...
1.  Navigate to **Settings -> Insights -> Targets Manager**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-736.png)
...
1.  Open the UDC list and click on the target UDC (e.g., UserTarget).
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-737.png)
...
1.  The imported data will appear in the UDC and be available in the Targets Manager.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-738.png)
...
1.  Navigate to **Settings -> Insights -> Data Queries**.
    ...
    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-739.png)

2.  Create a new query and select the target resource (e.g., UserTarget).

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-740.png)

3.  Configure the query:
    -   **Value Format:** Choose Currency or Decimal (default currency applies unless specified).

    ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-741.png)
    ...
    -   **Series:**
        ...
        -   For individual reps: Create a separate query without grouping.
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-742.png)
    ...
    -   **User Filter:**
        ...
        -   For reps: Select "Current User" (create separate queries for each role).
            ...
            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-743.png)

    -   **Date Filter:** Filter by This Month to view current month targets (uses the Date column in the UDC).

        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-744.png)
...
3.  In the **Content** tab, select two queries:
    ...
    -   Target values query (e.g., "Manager Rep Targets this Month").
        ...
        ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-745.png)
