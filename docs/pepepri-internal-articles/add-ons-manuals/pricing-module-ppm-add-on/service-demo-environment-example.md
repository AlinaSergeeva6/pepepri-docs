    ...
    -   **HTTP Tab:**
        ...
        -   **Body Example:**
            -   **CollectionName**: Name of the collection you'd like to update.
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-893.png)

                -   **ItemExternalID**: External ID of the item to which related items will be assigned.

            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-894.png)

            -   **RelatedItems:** Array of Item External IDs which will be assigned to the main item.

            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-895.png)

            -   **Key:** CollectionName\_ItemExternalID.

            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-896.png)
    ...
    -   **HTTP Tab:**
        ...
        -   **Body Example:**
            ...
            -   **SecondaryKey:** "CollectionName\_\[UUID of the main item\]":
                ...
                ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-897.png)

            -   **Values**: \[{"RelatedItems":\["**UUID** of assigned item","**UUID2** of assigned item"....\]}\]

            ![](https://alinasergeeva6.github.io/pepepri-docs/pepepri-internal-articles/static/image-898.png)
