...
{% swagger baseUrl="https://api.pepperi.com/v1.0" path="/code_jobs" method="post" summary=" Upsert Code Job" %}
{% swagger-description %}
Upsert By UUID
{% endswagger-description %}

{% swagger-parameter in="header" name="X-Pepperi-OwnerID" required="true" %}
the requested addon uuid
{% endswagger-parameter %}

{% swagger-parameter in="body" name="json body" type="json" %}
