# Get Single User by ExternalID

{% swagger baseUrl="https://api.pepperi.com/v1.0" path="/users/externalid/{external_id}" method="get" summary="Get Single User By ExternlID" %}
{% swagger-description %}
This endpoint allows you to get free cakes.
{% endswagger-description %}

{% swagger-parameter in="path" name="external_id" type="string" %}
The externalID of the user to get
