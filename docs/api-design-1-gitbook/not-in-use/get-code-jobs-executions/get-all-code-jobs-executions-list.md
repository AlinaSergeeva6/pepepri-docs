# Get All Code Jobs Executions List

{% swagger baseUrl="https://api.pepperi.com/v1.0" path="/code_jobs/executions" method="get" summary="Get All Code Job Executions List" %}
{% swagger-description %}
