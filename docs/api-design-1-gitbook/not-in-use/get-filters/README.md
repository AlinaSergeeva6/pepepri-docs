...
{% swagger baseUrl="https://api.pepperi.com/v1.0" path="/meta_data/filters" method="get" summary="Get Cakes" %}
{% swagger-description %}
...
{% swagger-response status="200" description="Filter successfully retrieved." %}
```javascript
{
  "InternalID": 35660,
  "Name": "hadatTests",
