...
{% swagger method="post" path="/accounts/unassign/{chain_key}" baseUrl="https://api.pepperi.com/v1.0" summary="" %}
{% swagger-description %}
...
List of accounts for unassigning from chain
{% endswagger-parameter %}
