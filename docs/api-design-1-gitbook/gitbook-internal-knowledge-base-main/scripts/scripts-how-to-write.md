...
1.  [#scripts-for-transactions](scripts-how-to-write.md#scripts-for-transactions "mention")

    &#x20;   [#useful-functions](scripts-how-to-write.md#useful-functions "mention")
2. [#scripts-for-pages](scripts-how-to-write.md#scripts-for-pages "mention")
   1. [#filter-resource-view-data](scripts-how-to-write.md#filter-resource-view-data "mention")
   2. [#page-parameters](scripts-how-to-write.md#page-parameters "mention")
   3. [#flow-for-buttons-and-banners-filtering](scripts-how-to-write.md#flow-for-buttons-and-banners-filtering "mention")
3. [#how-to-trigger-scripts-from-workflow](scripts-how-to-write.md#how-to-trigger-scripts-from-workflow "mention")
...
<div align="left"><figure><img src="../.gitbook/assets/image (1004).png" alt="" width="251"><figcaption></figcaption></figure></div>

<div align="left"><figure><img src="../.gitbook/assets/image (1005).png" alt="" width="493"><figcaption></figcaption></figure></div>
...
{% hint style="info" %}
If you use the '**on load**' event, `transaction.transactionScope.getLines()` will return all items **before** catalog filters. <mark style="color:red;">This may affect the performance.</mark>
...
<div align="left"><figure><img src="../.gitbook/assets/image (1006).png" alt="" width="430"><figcaption></figcaption></figure></div>

7\) Add **UserScriptBlock** and click on Edit:

<div align="left"><figure><img src="../.gitbook/assets/image (1007).png" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/image (793).png" alt="" width="563"><figcaption></figcaption></figure></div>
...
For additional information check [scripts-vs-code.md](scripts-vs-code.md "mention") article.
{% endhint %}
...
2. Search resource (all properties in the search object are optional)
...
<div align="left"><figure><img src="../.gitbook/assets/image (804).png" alt="" width="396"><figcaption></figcaption></figure></div>
...
3. Create a flow that contains that script;
4. Pages: add a Rich Text block, select flow, and pass configuration.
5. The HTML will be inserted into the Page.
...
<div align="left"><figure><img src="../.gitbook/assets/image (1063).png" alt="" width="239"><figcaption></figcaption></figure></div>

2\) Add new:

<div align="left"><figure><img src="../.gitbook/assets/image (1064).png" alt="" width="249"><figcaption></figcaption></figure></div>

3\) "Events" tab -> Add:

<div align="left"><figure><img src="../.gitbook/assets/image (1066).png" alt="" width="563"><figcaption></figcaption></figure></div>

4\) Select Event: OnResourceListLoad -> Click "Update":

<div align="left"><figure><img src="../.gitbook/assets/image (1067).png" alt="" width="331"><figcaption></figcaption></figure></div>

5\) Drag and drop "UserScriptsBlock" and select your Script:

<div align="left"><figure><img src="../.gitbook/assets/image (1068).png" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/image (1070).png" alt="" width="563"><figcaption></figcaption></figure></div>
...
2. You can use **filter concatenation** if needed:&#x20;
...
<div align="left"><figure><img src="../.gitbook/assets/image (777).png" alt="" width="128"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/image (776).png" alt="" width="331"><figcaption></figcaption></figure></div>
