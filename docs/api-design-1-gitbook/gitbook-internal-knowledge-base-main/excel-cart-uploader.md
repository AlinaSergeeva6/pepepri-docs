...
description: >-
  ...
  the Excel Cart Uploader in Pepperi.
---
...
*   Navigate to **Settings -> iPaaS -> Quick Setup -> Excel Cart Uploader**.<br>

    <figure><img src=".gitbook/assets/image (31).png" alt="" width="339"><figcaption></figcaption></figure>
...
*   **Select Transaction:** Choose the Transaction Type (e.g., Sales Order, B2B Order) that will be updated with the uploaded Excel data.<br>

    <figure><img src=".gitbook/assets/image (35).png" alt="" width="563"><figcaption></figcaption></figure>

**Excel Fields Mappings Tab**<br>
...
*   **Add Field:** Click **Add** to include a new field in the uploader configuration.<br>

    <figure><img src=".gitbook/assets/image (37).png" alt="" width="563"><figcaption></figcaption></figure>
*   **Edit Field:** Click **Edit** to update the Column Name or Source Field as needed.<br>
...
<figure><img src=".gitbook/assets/image (40).png" alt="" width="320"><figcaption></figcaption></figure>
...
1. **Create Custom Form with UI Task:**
   ...
   *   Click the icon to copy the UI task code.<br>

       <figure><img src=".gitbook/assets/image (41).png" alt="" width="494"><figcaption></figcaption></figure>
2. **Add Program to Transaction Type:**
   ...
   *   Add a new **Custom Form Action** and paste the copied UI task code.<br>
