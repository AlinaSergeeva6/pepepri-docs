...
1. [Enable Edit/Delete a Package in the Shopping Cart.](promotions-advanced-configuration.md#id-1.-enable-edit-delete-a-package-in-the-shopping-cart)
2. [Translate Package Messages.](promotions-advanced-configuration.md#id-2.-translate-package-messages)
3. [Copy Field Values from the Original Transaction to the Package Transaction.](promotions-advanced-configuration.md#id-3.-copy-field-values-from-original-to-package-transaction)
4. [Pass the Promotion Code to Line Items in the Original Transaction.](promotions-advanced-configuration.md#id-4.-pass-promotion-code-to-line-items-in-original-transaction)
5. [Merge Pricing Fields from the Package Transaction to the Original Transaction.](promotions-advanced-configuration.md#id-5.-merge-pricing-fields-from-package-to-original-transaction)
6. [Set Up Predefined Kits (Non-Editable Quantities).](promotions-advanced-configuration.md#id-6.-set-up-predefined-kits-non-editable-quantities)
7. [Assign Catalogs to Package Transactions.](promotions-advanced-configuration.md#id-7.-assign-catalogs-to-package-transactions)
8. [Apply Item Promotion Discounts Inside a Package Promotion.](promotions-advanced-configuration.md#id-8.-apply-item-promotion-discounts-inside-a-package-promotion)
9. [Define Specific Account/Item Lists for Selection.](promotions-advanced-configuration.md#id-9.-define-specific-account-item-lists-for-selection)
10. [Set Field Values on the Package Leading Item Line.](promotions-advanced-configuration.md#id-10.-set-field-values-on-the-package-leading-item-line)
11. [Apply Package Promotion Discounts to Line Views or Custom Fields.](promotions-advanced-configuration.md#id-11.-apply-package-promotion-discounts-to-line-views-or-custom-fields)
12. [Configure Order Promotions with TSA Fields.](promotions-advanced-configuration.md#id-12.-configure-order-promotions-with-tsa-fields)
...
* **Steps:**
  1.  Go to **Settings → Sales Activities → Transaction Types → \[PPI\_PackagePromotion or PPI\_PackagePromotionAdditionalItems] → Settings**.<br>
