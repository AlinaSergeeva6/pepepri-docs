...
[Duplicate the target transaction](../../pepperi/pepperi-configuration-general/sales-activities/duplicate-a-transaction-activity-type.md) (e.g., "Sales Order" to "Sales Order with Promotions") for testing:
...
2.  **Define Promotion Types in the Types Editor:**
    ...
    * Go to **Settings → Promotion Setup → Item TP Types Editor**.
    ...
    <figure><img src="../../.gitbook/assets/image (723).png" alt="" width="242"><figcaption></figcaption></figure>
...
4. **Create Item Lists:**
   ...
   *   Define a default list (if preferred):
       ...
       * Enter the List ID\
       ...
       <figure><img src="../../.gitbook/assets/image (724).png" alt="" width="375"><figcaption></figcaption></figure>
5. **Modify Next Discount Message Text:**
