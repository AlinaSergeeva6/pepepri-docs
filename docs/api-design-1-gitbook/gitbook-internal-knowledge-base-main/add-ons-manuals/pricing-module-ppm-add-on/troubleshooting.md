...
2. **Installed scripts for VS Code**. Refer to [this article](../../scripts/scripts-vs-code.md) for installation instructions.
...
1.  **Open Transaction**:
    ...
    * Open a transaction that uses the **PPM add-on** and wait for it to load.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot 2025-03-11 112359 (1).png" alt="" width="563"><figcaption></figcaption></figure>
2.  **Attach Debugger**:

    * Open the **script folder** in your project.
    * Attach the debugger in VS Code.

    <figure><img src="../../.gitbook/assets/Screenshot 2025-03-11 112459 (1).png" alt="" width="563"><figcaption></figcaption></figure>

    * If the debugger attaches successfully, you will see logs in the **Debug Console**.

    <figure><img src="../../.gitbook/assets/Screenshot 2025-03-11 112529 (1).png" alt="" width="563"><figcaption></figcaption></figure>
3.  **Check Logs**:

    * Look for logs prefixed with **PPM** – these are the necessary logs for debugging the PPM module.

    <figure><img src="../../.gitbook/assets/image (1).jpg" alt="" width="563"><figcaption></figcaption></figure>
...
*   Go back to the transaction and trigger the **pricing calculation**.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot 2025-03-11 112602 (1).png" alt="" width="563"><figcaption></figcaption></figure>
*   In **VS Code**, you will see the **debug breakdown** and the current state of the pricing calculation.

    <figure><img src="../../.gitbook/assets/Screenshot_8 (1).png" alt="" width="563"><figcaption></figcaption></figure>
...
*   While debugging, you can:
    ...
    * **Add breakpoints** or additional debugger statements at specific lines in the code.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot_3 (2).png" alt="" width="563"><figcaption></figcaption></figure>
...
1.  **Close Transaction**:
    ...
    * Close the transaction after making changes to the script.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot_4 (3).png" alt="" width="563"><figcaption></figcaption></figure>
2.  **Run Sync**:
    ...
    * **Note**: Re-syncing does not reload script files, so your code changes remain in the application.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot_5 (2).png" alt="" width="563"><figcaption></figcaption></figure>
...
1.  **Reopen Transaction**:
    ...
    * Return to the transaction and trigger the pricing calculation again.
    ...
    <figure><img src="../../.gitbook/assets/Screenshot_6 (1).png" alt="" width="563"><figcaption></figcaption></figure>
2. **Debugger Stops at New Code**:
   *   In **VS Code**, the debugger will stop at the lines you added or modified, allowing you to inspect the state and verify the changes.
       ...
       <figure><img src="../../.gitbook/assets/Screenshot_9 (2).png" alt="" width="563"><figcaption></figcaption></figure>
