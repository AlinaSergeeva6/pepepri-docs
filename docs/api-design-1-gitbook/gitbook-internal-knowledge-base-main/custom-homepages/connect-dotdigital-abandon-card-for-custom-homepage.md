...
In that function we format all transaction lines and send to dotDigital.\
\
You will need to ask a customer emails and dotDigital code for **window.dmPt('create', 'DM-0395272459-02', 'shop.ogieyewear.com,ogieyewear.com');** function.\
&#x20;After this you just change ProgramID here:
...
{% file src="../.gitbook/assets/customweb_header.txt" %}
