...
<xsl:stylesheet
    ...
    <xsl:variable name="DisplayCurrencyinSubTotals" select="false()" />
    <!--FOR DISPLAY CURRENCY IN LINES SET "true"-->
    <xsl:variable name="DisplayCurrencyinLines" select="false()" />
    <!--FOR DISPLAY CURRENCY IN FOOTER SET "true"-->
    <xsl:variable name="DisplayCurrencyinFooter" select="false()" />
