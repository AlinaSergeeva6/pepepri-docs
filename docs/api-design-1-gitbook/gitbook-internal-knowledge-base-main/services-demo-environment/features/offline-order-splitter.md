...
3. Add items to the cart and select the 'OrderTypeSelector' dropdown.\
   Different items can have different values. In order to see results, you need to select a few different transaction types for different items.
