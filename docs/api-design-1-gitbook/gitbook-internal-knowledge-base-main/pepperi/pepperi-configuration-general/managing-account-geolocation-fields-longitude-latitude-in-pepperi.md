---
description: >-
  This guide provides instructions for managing the automatic population of
  Account fields Longitude and Latitude by the Pepperi backend process using the
  Google API.
---
...
* **Solution:**
  *   Manually search the address on Google to identify corrections (e.g., add missing spaces or correct spelling).<br>
