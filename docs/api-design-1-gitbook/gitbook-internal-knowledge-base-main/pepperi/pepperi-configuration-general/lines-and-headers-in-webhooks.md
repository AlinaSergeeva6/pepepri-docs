---
description: >-
  This guide demonstrates how to create a Webhook Task in Pepperi to import
  transaction headers and lines into a client table using SQL. This is
  particularly useful for tasks like importing sales orders
---
