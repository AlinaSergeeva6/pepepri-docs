...
Means, Webhook action in workflow with checked checkbox 'retry' (**Invoker**) is sending HTTP request to the URL specified inside with such body:<br>
...
{% embed url="https://kbint.pepperi.com/integration-platform-webhook-tasks-examples/amazon-webhook-service" %}
