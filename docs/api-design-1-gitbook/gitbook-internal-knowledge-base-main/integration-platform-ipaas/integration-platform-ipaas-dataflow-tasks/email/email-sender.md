---
description: >-
  This article could be helpful if you are going to create email newsletter for
  some customers. All examples of tasks are on the Integration Examples (6685)
  integration account.
---
