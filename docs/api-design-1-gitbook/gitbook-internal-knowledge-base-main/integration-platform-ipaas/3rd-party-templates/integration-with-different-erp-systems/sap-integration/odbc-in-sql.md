---
description: >-
  This example you can find in 'Integration Examples' (6685) SAP(ODBC) dataflow
  task.
---
...
This is correct name of the ODBC driver you need to use later. Then follow all the steps that are described in the "**First Time Plugin Installation"** article. Link below:\
[https://kbint.pepperi.com/integration-platform-ipaas/integration-with-different-erp-systems/quickbooks-desktop-integration/first-time-plugin-installation](https://kbint.pepperi.com/integration-platform-ipaas/integration-with-different-erp-systems/quickbooks-desktop-integration/first-time-plugin-installation)
