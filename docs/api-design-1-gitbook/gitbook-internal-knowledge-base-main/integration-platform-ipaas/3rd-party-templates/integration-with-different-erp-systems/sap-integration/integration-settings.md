...
| servertype                        | 2012                                                                                                                | Mandatory          | <p>SQL Server Version/ Hana. </p><p>Query: <code>SELECT @@VERSION AS 'SQL Server Version';</code></p>              |
...
| sql\_connection                   | <p>Data Source=QB1;</p><p>Integrated Security=False;</p><p>User ID=sa;</p><p>Password=Wrnty8888</p>                 | Mandatory          | SQL connection string                                                                                              |
| timerinterval                     | 10000                                                                                                               | Optional           | Time Interval To Shut Down the Importer                                                                            |
| trn\_status                       | <p>regular</p><p>draft</p><p>none</p>                                                                               | Optional           | Different tables for different transaction statuses - allows                                                       |
| trn\_import\_filter               | <p><code>UnitsQuantity&#x3C;>0</code> </p><p><code>AND</code> </p><p><code>and ItemExternalID &#x3C;> ''</code></p> | Optional           | Filter lines                                                                                                       |
