...
#### 2) KANGAROO REWARDS API Docs (Documentation for working with API) - [https://api.kangaroorewards.com/docs/business.html](https://api.kangaroorewards.com/docs/business.html)  APP CAPABILITIES
...
More examples of http requests to retrieve data from Kangaroo Api at the link:\
[https://api.kangaroorewards.com/docs/business.html#customers](https://api.kangaroorewards.com/docs/business.html#customers)
...
**Webhook for Update Kangaroo Points Example**:\
[https://integration.pepperi.com/mgr/PluginSettings/ClientTask?TaskId=67524](https://integration.pepperi.com/mgr/PluginSettings/ClientTask?TaskId=67524%09)
