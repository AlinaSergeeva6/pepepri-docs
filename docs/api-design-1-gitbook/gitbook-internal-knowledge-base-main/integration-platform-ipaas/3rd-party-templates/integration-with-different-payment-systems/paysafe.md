...
description: >-
  ...
  integration platform account (Dataflow task: “PaySafe Tasks Folder” ->
  “Authorization”;  UI task: “PaySafe Payment”);
---
...
5\.       You will receive a security token by email. Enter this token and click **Next**.\
