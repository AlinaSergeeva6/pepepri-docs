...
This syntax can be used when loop over table or webhook has a place\
if you have multiple lines in source (loop\_over\_table) or you have more than one line in transaction you need to use it. For example, in webhook you need to POST array of lines like:
...
You can combine it with previous one\
"**$#@\*Image\_URL\*@#$"**
