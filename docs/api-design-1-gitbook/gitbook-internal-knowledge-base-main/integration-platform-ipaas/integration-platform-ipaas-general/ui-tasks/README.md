...
description: >-
  ...
  integration platform account, UI task: "Training Example”
---

# UI Tasks

By UI task  you can implement logic, visualize data. It is used for various types of reports, logic programs. Here is used HTML, CSS, JavaScript, jQuery, Kendo. \
UI tasks always work only online. The advantage is the use of external libraries, also you can extract data from the  Dataflow task, or vice versa, send the necessary data to Dataflow. For example, data for an email attachment that is sent by Dataflow etc.
...
Here you should write an application that task will use.\
Use table below to select correct application
