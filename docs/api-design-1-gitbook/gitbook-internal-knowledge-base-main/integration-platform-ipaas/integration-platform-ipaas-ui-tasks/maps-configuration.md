...
description: >-
  ...
  integration platform account, UI task: “manage KendoMap”
---
...
![Example of map](<../../.gitbook/assets/1 (8).jpg>)
...
&#x20;where "**location**" - geolocation to be displayed; "**shape**" -  shape of marker, "**content**" - name of your marker.\
Markers can be varied. For example, standard markers are "pin", "pinTarget", or you can create custom marker. For this&#x20;\
just change “shape” ,for example, to “customMarker” and add it to the style:
...
![Example of markers](../../.gitbook/assets/2.jpg)
...
![Example of satellite map ](<../../.gitbook/assets/3 (3).jpg>)

{% file src="../../.gitbook/assets/KendoMap.txt" %}
Example of code
{% endfile %}
